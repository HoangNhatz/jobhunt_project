...
class AdminLoginController extends Controller
{
    ...
    public function forget_password_submit(Request $request) {
        ...
        return redirect()->route('admin_login')->with('success','Please check your mail and follow the steps there.');
    }
    ...
    public function reset_password_submit(Request $request) {
        ...
        return redirect()->route('admin_login')->with('success', 'Password is reseted successfully!');
    }
}
