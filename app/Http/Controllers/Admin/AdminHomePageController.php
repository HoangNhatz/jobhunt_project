...
class AdminHomePageController extends Controller
{
    ...
    public function update(Request $request) {
        ...
        if($request->hasFile('why_choose_background')) {
            ...
            File::delete(public_path('uploads\\'.$page_home_data->why_choose_background));
        ...
        if($request->hasFile('testimonial_background')) {
            ...
            File::delete(public_path('uploads\\'.$page_home_data->testimonial_background));
            ...
            $page_home_data->testimonial_background = $final_name2;
        }
