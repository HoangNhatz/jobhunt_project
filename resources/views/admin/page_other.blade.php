                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="login_page_meta_description" class="form-control h_100" id="" cols="30" rows="10">{{ $page_other_data->login_page_meta_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>                                     
                                    ...
                                    <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Meta Description </label>
                                                    <textarea name="signup_page_meta_description" class="form-control h_100" id="" cols="30" rows="10">{{ $page_other_data->signup_page_meta_description }}</textarea>
                                                </div>
                                            </div>
                                        </div> 
                                    ...
                                    <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab" tabindex="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Meta Description </label>
                                                    <textarea name="forget_password_page_meta_description" class="form-control h_100" id="" cols="30" rows="10">{{ $page_other_data->forget_password_page_meta_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
